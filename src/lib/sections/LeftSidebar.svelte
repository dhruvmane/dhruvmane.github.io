...
<div class="hidden lg:w-1/3 md:flex flex-col lg:block h-full text-white p-10 text-2xl sticky top-0 self-start">
    ...
    <div class="py-10 px-30">
        <div class="py-2 flex flex-col gap-1">
            <a rel="noopener noreferrer" target="_blank" href="https://github.com/dhruvmane/dhruvmane.github.io" class="-skew-y-ui w-fit flex gap-2.5 items-center">
                <Icon icon="bxl:github"/>
                <h4 class="text-[13px]"> source code</h4>
            </a>
            <a rel="noopener noreferrer" target="_blank" href="https://github.com/officialbarden" class="-skew-y-ui w-fit flex gap-2.5 items-center">
                <Icon icon="bxl:github"/>
                <h4 class="text-[13px]"> my alt</h4>
            </a>
            <div class="-skew-y-ui w-fit flex gap-2.5 items-center">
                <Icon icon="bi:discord"/>
                <h4 class="text-[13px]">@dhruvmane</h4>
            </div>
        </div>
    </div>
    ...
    <h2 class="-skew-y-ui mb-1 text-[12px] font-mono mx-30">
        Powered by
    ...
    <details class="-skew-y-ui absolute mx-30 w-40 text-[12px] font-mono hover:cursor-pointer duration-500">
