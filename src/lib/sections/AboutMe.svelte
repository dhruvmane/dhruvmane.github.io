...
<main class="p-10 bg-neutral-900 w-[800px] duration-300 shadow-[10px_10px_0px] shadow-black border-4 border-black select-none">
     ...
     <div class="flex mb-10 gap-x-10 border-4 border-black shadow-[5px_5px_0px] shadow-black">
          <a href="https://github.com/dhruvmane" class="hover:scale-102">
          ...
          <div class="mt-6">
               ...
               <p class="m-2 text-sm font-light">I am a First Year Computer Science Student.</p>
          </div>
     </div>
     ...
     <div class="flex gap-x-4">
          ...
          <div class="p-2 border-4 shadow-[5px_5px_0px] w-1/2 shadow-black border-black">
               ...
               <div class="flex flex-wrap gap-2 p-2">
                    <a href="https://www.linkedin.com/in/dhruv-mane-1b4b4935b/" class="flex gap-x-0.5 hover:underline">LinkedIn</a>
                    <a href="https://github.com/dhruvmane" class="hover:underline">Github</a>
                    <a href="http://instagram.com/dhruvvmh" class="hover:underline">Instagram</a>
               </div>
          </div>
