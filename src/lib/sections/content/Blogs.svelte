<script>
    ...
    // GET ALL BLOGS:
    let blogs = [];
    const allBlogs = import.meta.glob(`/src/lib/blogs/**/*.md`, {query: "?raw", import: "default"})
    
</script>

<main id="blogs" class="group p-10 w-120 md:w-200 duration-300">
