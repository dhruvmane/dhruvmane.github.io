...
let Talents = { 
    ...
    frameworks: [
        { name: "React", href: "https://react.dev/", icon: { name: "bxl:react" }},
    ...
    packages: [
        ...
        { name: "Neo4j", href: "https://www.neo4j.com/", icon: { name: "cib:neo4j" }},
    ...
    misc: [
        ...
        { name: "Premiere Pro", href: "https://www.adobe.com/in/products/premiere.html", icon: { name: "streamline-logos:adobe-premiere-pro-logo-block" }},
        { name: "Figma", href: "https://www.figma.com/", icon: { name: "bxl:figma" }},
        { name: "Blockbench", href: "https://blockbench.net/", icon: { name: "simple-icons:blockbench" }},
    ],
}
